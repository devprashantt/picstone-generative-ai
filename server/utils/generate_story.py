...
def generate_story(tags, tag_analysis, image_text):
    ...
    prompt = f"Immerse yourself in the art of storytelling. Your task is to craft a captivating narrative, a story that unfolds over at least 500 words. You'll draw inspiration from a selection of tags, each one a unique element in your storytelling palette: {', '.join(tags)} and use these words {image_text}. These tags will guide the tone of your narrative, lending it a {tone} quality. The sentiment you'll infuse into your words should resonate with {sentiment}, and the overall mood should be nothing less than {mood}. Imagine your readers, eager to embark on this literary journey you're about to create. They await a story that's not just words on a page but an experience that evokes emotions, thoughts, and memories. Your canvas is ready; the colors are your tags, the brush is your pen, and your palette includes {', '.join(tags)}. Start your narrative, and let the world of words come alive."
